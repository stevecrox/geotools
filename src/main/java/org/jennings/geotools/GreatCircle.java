 ...
 * @author david
 * 
 * The Great Circle is the shortest path from two points on a sphere (e.g. Earth)
 * 
...
public class GreatCircle {
    ...
    /**
     * 
     * Given two geographic points find the distance and bearing between the points.
     * 
     * @param lon1
     * @param lat1
     * @param lon2
